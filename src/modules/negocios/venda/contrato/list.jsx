...
const mapStateToProps = (state) => ({
  contratosAll: state.vendaContrato.contratosAll,
  contratosAtivos: state.vendaContrato.contratosAtivos,
  contratosInativos: state.vendaContrato.contratosInativos,
  isLoadingAll: state.vendaContrato.isLoadingAll,
