...
class DoacaoRecorrenteReservaNovo extends React.Component {
  componentDidMount () {
...
const mapStateToProps = (state) => ({
  diaFailure: state.doacaoVitrine.diaFailure
})
const mapDispatchToProps = (dispatch) => ({ redirectToReservaDoDia, dispatch })
export default connect(mapStateToProps, mapDispatchToProps)(DoacaoRecorrenteReservaNovo)
