...
class DoacaoRecorrenteEntregaComprador extends React.Component {
  componentDidMount () {
...
const mapStateToProps = (state) => ({
  diaFailure: state.doacaoReserva.diaFailure
})
const mapDispatchToProps = (dispatch) => ({ redirectToEntregaDoDia, dispatch })
export default connect(mapStateToProps, mapDispatchToProps)(DoacaoRecorrenteEntregaComprador)
